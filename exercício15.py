...
if a >b and a<c:
    print("O número que escolheste é maior do que os números que estou a pensar.")
elif a >b and a<c:
    print("O número que escolheste é maior do que um dos números que estou a pensar, mas menos do que outro")
else:
    print("O número que escolheste é menor do que números em que estou a pensar.")

#uso do OR
#usamos o OR em condicionais quando queremos uma condição MÚLTIPLA em que BASTA QUE UMA
DAS CONDIÇÕES se verifique para ser verdadeira,
ou seja:
